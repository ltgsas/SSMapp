...
public interface CasebaseMapper {
     ...
     * @return casebasic
     */
    Casebase getByColumnOnID(int id);
     ...
     * @return
     */
    List<Casebase> ListMoreRecordsFromCasebase(@Param("scope") String scope);

    /**
     * 动态使用表名 只能使用 ${tableName} 不能使用 #{tableName}
     * @param tableName
     */
    List<Casebase> ListDynamicTable(@Param("tableName") String tableName);
     ...
     */
    List<Casebase> listByColumnInCname(@Param("name") String name);
     ...
     */
    List<Casebase> listByColumnAndValue(@Param("columnName") String columnName, @Param("columnValue") String columnValue);
    ...
    List<Casebase> listByColumnUseMap(HashMap map);
     ...
     * @return List<Casebasic>
     */
    List<Casebase> listByLimitUseMap(HashMap Map);

    /**
     * 分页查询示例2: RowBounds -- 不推荐使用,
     * 默认情况下的 RowBounds 无法获取查询总数
     */
    List<Casebase> listUseRowBounds();
     ...
     * @return List<Casebasic>
     */
    List<Casebase> listByColumnOnGrade(String gradeNumber);
    ...
    Map<String,Object> getByIdToMapFromCasebase(@Param("id") Integer id);
     ...
     * @return
     */
    @Select("select * from casebase limit 800,5")
    List<Map<String,Object>> listAllToMapFromCasebase();
     ...
     */
    @MapKey("id")
    Map<String,Object> getAllToMapFromCasebase();
}
